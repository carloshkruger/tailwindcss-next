...
const button = tv({
  ...
  variants: {
    variant: {
      ...
      outline:
        'border border-zinc-300 text-zinc-700 hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-400 dark:hover:bg-white/5',
      ghost:
        'rouded-md px-2 hover:bg-zinc-50 shadow-none dark:hover:bg-zinc-800 dark:text-zinc-400',
    },
  },
})
